...
{
    class SuggestionsForPurchaseConditionRecord
    {
        ...
        public SuggestionsForPurchaseConditionRecord(string company, string secretKey)
        {
        ...
        public void Init()
        {
            try
            {
                string targetUrl = string.Format("{0}{1}", domainUrl, "api/ERP/SuggestionsForPurchaseConditionRecord");
