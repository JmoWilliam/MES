...
{
    class DepartmentSynchronize
    {
        readonly string company;
        readonly string secretKey;
        //public static string domainUrl = "https://192.168.20.112:16668/";
        public static string domainUrl = "https://bm.zy-tech.com.tw/";
        public static Logger logger = LogManager.GetCurrentClassLogger();

        public DepartmentSynchronize(string company, string secretKey)
        {
        ...
        public void Init()
        {
            try
            {
                string targetDate = DateTime.Now.AddDays(-2).ToString("yyyy-MM-dd HH:mm:ss"),
                    targetUrl = string.Format("{0}{1}", domainUrl, "api/HRM/DepartmentSynchronize");
