...
namespace ERPSynchronize
{
    class MrDetailAbnormalMAMO
    {
        ...
        public MrDetailAbnormalMAMO(string company, string secretKey, string channelId)
        {
        ...
        public void Init()
        {
            try
            {
                string targetUrl = string.Format("{0}{1}", domainUrl, "api/MesReport/MrDetailAbnormalEIP");
