...
namespace ERPSynchronize
{
    class LotNumberSynchronize
    {
        ...
        public LotNumberSynchronize(string company, string secretKey)
        {
        ...
        public void Init()
        {
            try
            {
                string targetDate = DateTime.Now.AddDays(-2).ToString("yyyyMMdd HH:mm:ss"), //"19000101 00:00:00",
                    targetUrl = string.Format("{0}{1}", domainUrl, "api/ERP/LotNumberSynchronize");
                ...
                var postData = new List<KeyValuePair<string, string>>
                {
                    ...
                    new KeyValuePair<string, string>("NormalSync", "N"),
                    new KeyValuePair<string, string>("TranSync", "Y")
                };
