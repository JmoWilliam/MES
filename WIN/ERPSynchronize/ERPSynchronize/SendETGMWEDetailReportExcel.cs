...
{
    class SendETGMWEDetailReportExcel
    {
        readonly string company;
        readonly string secretKey;
        readonly string channelId;
        //public static string domainUrl = "http://192.168.134.52:16668/";
        public static string domainUrl = "https://bm.zy-tech.com.tw/";
        public static Logger logger = LogManager.GetCurrentClassLogger();

        public SendETGMWEDetailReportExcel(string company, string secretKey)
        {
        ...
        public void Init()
        {
            try
            {
                string targetUrl = string.Format("{0}{1}", domainUrl, "api/MES/SendETGMWEDetailReportExcel");
