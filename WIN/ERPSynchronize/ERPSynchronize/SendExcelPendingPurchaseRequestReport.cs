...
{
    class SendExcelPendingPurchaseRequestReport
    {
        readonly string company;
        readonly string secretKey;
        public static string domainUrl = "https://bm.zy-tech.com.tw/";
        public static Logger logger = LogManager.GetCurrentClassLogger();
        public SendExcelPendingPurchaseRequestReport(string company, string secretKey)
        {
        ...
        public void Init()
        {
            try
            {
                string targetUrl = string.Format("{0}{1}", domainUrl, "api/MES/apiSendExcelPendingPurchaseRequestReport");
