...
namespace ERPSynchronize
{
    class OspInAlertMamo
    {
        ...
        public OspInAlertMamo(string company, string secretKey)
        {
        ...
        public void Init()
        {
            try
            {
                string targetUrl = string.Format("{0}{1}", domainUrl, "api/OutsourcingProduction/OspInAlertMamo");
