...
namespace ERPSynchronize
{
    class NLogSynchronize
    {
        ...
        public NLogSynchronize(string company, string secretKey)
        {
        ...
        public void Init()
        {
            try
            {
                string targetDate = "-30",
                    targetUrl = string.Format("{0}{1}", domainUrl, "api/SYS/DeleteNLog");
