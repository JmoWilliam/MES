...
{
    internal class PMDSendSynchronize
    {
       ...
       //public static string domainUrl = "http://192.168.120.111:16668/";
        public static string domainUrl = "https://bm.zy-tech.com.tw/";
        public static Logger logger = LogManager.GetCurrentClassLogger();

        public PMDSendSynchronize(string company, string secretKey)
        {
        ...
        public void Init()
        {
            try
            {
                string targetUrl = string.Format("{0}{1}", domainUrl, "api/SCM/SendPMDOrderExcelsSY");
