...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="fal fa-file"></i>';
            ...
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = '<button type="{type}" tabindex="500" class="{css}" {status}>{icon} {label}</button>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="fal fa-trash"></i>',
                    removeClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="fal fa-upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="fal fa-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="fal fa-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fal fa-search-plus"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="fal fa-arrows"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="fal fa-plus-circle text-warning"></i>',
                    indicatorSuccess: '<i class="fal fa-check-circle text-success"></i>',
                    indicatorError: '<i class="fal fa-exclamation-circle text-danger"></i>',
                    indicatorLoading: '<i class="fal fa-hourglass text-muted"></i>',
                    indicatorPaused: '<i class="fal fa-pause-circle text-primary"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fal fa-caret-left"></i>',
            next: '<i class="fal fa-caret-right"></i>',
            toggleheader: '<i class="fal fa-arrows-v"></i>',
            fullscreen: '<i class="fal fa-expand-arrows"></i>',
            borderless: '<i class="fal fa-expand-alt"></i>',
        ...
        customLayoutTags: {},
        customPreviewTags: {},
        previewFileIcon: '<i class="fal fa-file"></i>',
        previewFileIconClass: 'file-other-icon',
        previewFileIconSettings: {},
        previewFileExtSettings: {},
        buttonLabelClass: 'hidden-xs',
        browseIcon: '<i class="fal fa-folder-open"></i>&nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="fal fa-trash"></i>',
        removeClass: 'btn btn-default btn-secondary',
        cancelIcon: '<i class="fal fa-ban"></i>',
        cancelClass: 'btn btn-default btn-secondary',
        pauseIcon: '<i class="fal fa-pause"></i>',
        pauseClass: 'btn btn-default btn-secondary',
        uploadIcon: '<i class="fal fa-upload"></i>',
        uploadClass: 'btn btn-default btn-success',
        uploadAsyncIcon: '<i class="fas fa-sync-alt"></i>',/*¸ü¤J*/
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadParamNames: {
        ...
        msgValidationErrorIcon: '<i class="fal fa-exclamation-circle"></i> ',
