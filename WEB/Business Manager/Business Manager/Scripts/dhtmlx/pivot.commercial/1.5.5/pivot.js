...
dhtmlxPivot v.1.5.5 Professional
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(21), __webpack_require__(70).setImmediate))
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(0);
var DateFormatter_1 = __webpack_require__(125);
...
Object.defineProperty(exports, "__esModule", { value: true });
var FocusManager_1 = __webpack_require__(24);
var html_1 = __webpack_require__(2);
                ...
                if (!col.hidden) {
                    ...
                    if (typeof content === "string") {
                        content = main_1.isHtmlEnable(conf, col)
                            ? dom_1.el("div.dhx_grid-cell__content", __assign(__assign({ ".innerHTML": content }, getEditBtnAriaAttrs()), { style: { lineHeight: row.$height + "px" } }))
                            : content;
                    }
...
var DataCollection = /** @class */ (function () {
    ...
    DataCollection.prototype.getInitOrder = function () {
        if (this._initOrder) {
            return this._initOrder;
        }
        else
...
var Exporter_1 = __webpack_require__(80);
var data_1 = __webpack_require__(10);
var cells_1 = __webpack_require__(15);
var main_1 = __webpack_require__(7);
...
var date_1 = __webpack_require__(14);
var content_1 = __webpack_require__(109);
var columnsResizer_1 = __webpack_require__(110);
var ts_message_1 = __webpack_require__(111);
var keys_1 = __webpack_require__(116);
var FocusManager_1 = __webpack_require__(24);
...
var main_1 = __webpack_require__(7);
var Cells_1 = __webpack_require__(25);
var FixedCols_1 = __webpack_require__(108);
...
var events_1 = __webpack_require__(4);
var html_1 = __webpack_require__(2);
var keycodes_1 = __webpack_require__(101);
var view_1 = __webpack_require__(6);
var ts_data_1 = __webpack_require__(5);
var ts_layout_1 = __webpack_require__(16);
var ts_list_1 = __webpack_require__(46);
var ts_popup_1 = __webpack_require__(18);
var keyListener_1 = __webpack_require__(105);
        ...
        this._handlers = {
            ...
            onkeyup: function (e) {
                ...
                if (e.which === keycodes_1.KEY_CODES.BACKSPACE &&
                    (_this._state.canDelete || _this.config.multiselection) &&
            ...
            onfocus: function () { return _this.events.fire(types_2.ComboboxEvents.focus, []); },
            onblur: function () { return _this.events.fire(types_2.ComboboxEvents.blur, []); },
        };
    };
...
var types_1 = __webpack_require__(19);
var view_1 = __webpack_require__(6);
var Selection_1 = __webpack_require__(48);
var html_1 = __webpack_require__(2);
...
function getCustomContentCell(cell, column, config, rowName, css, colIndex, rowIndex) {
    ...
    return dom_1.el("." + type, __assign({ style: {
            class: css.trim(),
            padding: 0,
...
var TreeGridCollection = /** @class */ (function (_super) {
    ...
    TreeGridCollection.prototype._parse_data = function (data, parent) {
        ...
        for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
            ...
            if (this._pull[obj.id]) {
                ts_data_1.dhxError("Item " + obj.id + " already exist");
            }
            this._pull[obj.id] = obj;
    ...
    TreeGridCollection.prototype._checkItems = function () {
        ...
        this.eachChild(this._root, function (item) {
            ...
            item.$opened = core_1.isDefined(item.$opened) ? item.$opened : haveItems;
...
var dom_1 = __webpack_require__(1);
var html_1 = __webpack_require__(2);
var Filters_1 = __webpack_require__(58);
var en_1 = __webpack_require__(11);
...
var Configurator = /** @class */ (function () {
    function Configurator(pivot, config) {
        ...
        this._handleMouseMove = function (e) {
            ...
            if (Math.abs(pageX - _this._pressedCoords.x + pageY - _this._pressedCoords.y) < 10) {
                return;
            }
            ...
            var x = clientX - (_this._pressedCoords.x - target.left);
            var y = clientY - (_this._pressedCoords.y - target.top);
        ...
        this._handleMouseup = function (_e) {
            if (_e.changedTouches) {
                _this._getDropArea(document.elementFromPoint(_e.changedTouches[0].clientX, _e.changedTouches[0].clientY));
            }
            document.removeEventListener("mousemove", _this._handleMouseMove);
            document.removeEventListener("touchmove", _this._handleMouseMove);
            document.removeEventListener("mouseup", _this._handleMouseup);
            document.removeEventListener("touchend", _this._handleMouseup);
    ...
    Configurator.prototype.setPressedItem = function (ev, id, node) {
        ...
        this._pressedCoords = {
            x: ev.pageX || ev.changedTouches[0].pageX,
            y: ev.pageY || ev.changedTouches[0].pageY,
            target: node,
        };
    ...
    Configurator.prototype._getDropArea = function (el) {
        if (!el.offsetParent)
            return;
        if (el.offsetParent.getAttribute("dhx_id") &&
            el.offsetParent.className.includes("dhx_config_field")) {
            this._dropArea = el.offsetParent.getAttribute("dhx_id");
            return;
        }
        this._getDropArea(el.offsetParent);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var DateFilter_1 = __webpack_require__(124);
...
exports.operations = {
    string: {
        ct: {
            ...
            handler: function (item, str) { return item.toLowerCase().includes(str.toLowerCase()); },
        },
        nct: {
...
Object.defineProperty(exports, "__esModule", { value: true });
var groupfuncs_1 = __webpack_require__(61);
var core_1 = __webpack_require__(0);
var en_1 = __webpack_require__(11);
var helpers_1 = __webpack_require__(20);
// [dirty]
...
function setRowsLabels(rows, uniqueRows, level, rowName, parent) {
    ...
    if (pivotConfig.layout.gridMode === "tree") {
        ...
        var hasDate_1 = 0;
        rows.forEach(function (row) { return (hasDate_1 = row.type === "date" && !row.group ? hasDate_1++ : hasDate_1); });
        if (rows[level].type === "date" && !rows[level].group && hasDate_1 !== rows.length) {
            text = helpers_1.dateToStr(text, rows[level].format || "%M %d %Y");
        }
        firstColumns[0] = text;
    }
    else {
...
function getHeader(config, columns) {
    ...
    if (pivotConfig.layout.gridMode === "tree") {
        ...
        rows.forEach(function (row) {
            if (row.type === "date" && !row.group) {
                hasDate_2++;
                if (row.format)
                    format_1 = row.format;
            }
        });
        var type = hasDate_2 === rows.length ? "date" : "string";
        result = [
            {
                id: (colId++).toString(),
                header: header,
        ...
        config.fields.rows.forEach(function (row) {
            ...
            var type = row.type && !row.group ? row.type : "string";
            var format = row.format && row.type === "date" && !row.group ? row.format : null;
            result.push({
                header: header,
                footer: footer,
                id: (colId++).toString(),
    ...
    for (var i = 0; i < columns.length; i++) {
        var _loop_3 = function (field) {
            ...
            if (config.layout && config.layout.footer) {
                col.footer = [{ content: field.method, align: "right" }];
            }
            result.push(col);
        };
...
function normalizeFooter(grid, cols) {
    ...
    var data = datacollection.map(function (i) { return i; });
    var _loop_4 = function (col) {
        ...
        if (content[col.method] && col.template) {
            ...
            col.footer = [{ text: htmlVal, align: col.align }];
        }
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var DataGroup_1 = __webpack_require__(60);
...
// HELPERS
var CssManager_1 = __webpack_require__(30);
...
// WIDGETS
var Pivot_1 = __webpack_require__(121);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(21), __webpack_require__(72)))
...
var CollectionStore_1 = __webpack_require__(118);
var types_1 = __webpack_require__(8);
var helpers_1 = __webpack_require__(9);
...
var Selection = /** @class */ (function () {
    ...
    Selection.prototype._toHTML = function (row, column, last) {
        ...
        var rows = this._grid.data.getRawData(0, -1);
...
var CheckboxEditor_1 = __webpack_require__(99);
var ComboboxEditor_1 = __webpack_require__(100);
var TextAreaEditor_1 = __webpack_require__(107);
var lastEditor = {
    cell: {
        row: null,
        col: null,
...
var dom_1 = __webpack_require__(1);
var types_1 = __webpack_require__(3);
var ts_calendar_1 = __webpack_require__(86);
var date_1 = __webpack_require__(14);
var ts_popup_1 = __webpack_require__(18);
...
var events_1 = __webpack_require__(4);
var view_1 = __webpack_require__(6);
var ts_timepicker_1 = __webpack_require__(88);
...
var view_1 = __webpack_require__(6);
var ts_layout_1 = __webpack_require__(16);
var ts_slider_1 = __webpack_require__(93);
...
var ProCell_1 = __webpack_require__(92);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Combobox_1 = __webpack_require__(45);
var ts_list_1 = __webpack_require__(46);
var ts_layout_1 = __webpack_require__(16);
var helper_1 = __webpack_require__(50);
        ...
        comboFilter: {
            ...
            match: function (value, match) {
                ...
                if (Array.isArray(match)) {
                    var result = void 0;
                    for (var i = 0; i < match.length; i++) {
                        result = match[i] === value || value.includes(match[i]);
                        if (result)
                            break;
                    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var Grid_1 = __webpack_require__(36);
var types_1 = __webpack_require__(3);
var ts_data_1 = __webpack_require__(5);
var html_1 = __webpack_require__(2);
var data_1 = __webpack_require__(10);
...
var ProGrid = /** @class */ (function (_super) {
    ...
    ProGrid.prototype._prepareData = function (data) {
        ...
        if (Array.isArray(data) || ts_data_1.isTreeCollection(data)) {
            ...
            convertedData =
                data.getInitOrder().length !== 0 ? data.getInitOrder() : data.getRawData(0, data.getLength());
        }
...
var view_1 = __webpack_require__(6);
var ts_data_1 = __webpack_require__(5);
var ts_treegrid_1 = __webpack_require__(122);
var ts_layout_1 = __webpack_require__(16);
var Configurator_1 = __webpack_require__(57);
var Fields_1 = __webpack_require__(126);
var DataPreprocessor_1 = __webpack_require__(127);
var DataGroup_1 = __webpack_require__(60);
var groupfuncs_1 = __webpack_require__(61);
var CssManager_1 = __webpack_require__(30);
var en_1 = __webpack_require__(11);
var types_1 = __webpack_require__(29);
var Exporter_1 = __webpack_require__(128);
var Shadow_1 = __webpack_require__(129);
var Pivot = /** @class */ (function (_super) {
    ...
    function Pivot(container, config) {
        ...
        _this._htmlEvents = {
            ...
            ontouchstart: html_1.eventHandler(function (ev) { return html_1.locate(ev); }, {
                dhx_config_item: function (ev, item) {
                    var fieldNode = html_1.locateNode(ev.target);
                    _this._configurator.setPressedItem(ev, item, fieldNode);
                },
    ...
    Pivot.prototype._update = function () {
        ...
        var preParseData = JSON.parse(JSON.stringify(gridInfo.groupedData));
        this.grid.setColumns(gridInfo.headers);
        this.grid.data.parse(gridInfo.groupedData);
        if (this.config.layout.gridMode === "flat") {
            this.grid.data.forEach(function (item) {
                item.$level = preParseData.find(function (i) { return i.id === item.id; }).$level;
            });
        }
...
var core_1 = __webpack_require__(0);
var ts_data_1 = __webpack_require__(5);
var TreeGridCollection_1 = __webpack_require__(55);
...
var TreeGrid = /** @class */ (function (_super) {
    ...
    function TreeGrid(container, config) {
        ...
        if (!_this.config.dropBehaviour) {
            _this.config.dropBehaviour = "complex";
        }
        _this.config.type = "tree";
        return _this;
    }
    TreeGrid.prototype.scrollTo = function (rowId, colId) {
        var selectedCell = this.selection.getCell();
        var columns = this.config.columns.filter(function (col) { return !col.hidden; });
        var colInd = core_1.findIndex(columns, function (_a) {
            var id = _a.id;
        ...
        var prevColInd = core_1.findIndex(columns, function (obj) { return obj.id == prevCol.id; });
        var fixedColsWidth = this.config.leftSplit
            ? ts_grid_1.getTotalWidth(columns.slice(0, this.config.leftSplit))
            : 0;
        var x = ts_grid_1.getTotalWidth(columns.slice(0, colInd)) - (colInd - prevColInd < 0 ? fixedColsWidth : 0);
        var rows = this.data.mapVisible(function (i) { return i; });
        var rowInd = core_1.findIndex(rows, function (_a) {
            var id = _a.id;
            return id == rowId;
        });
        var y = ts_grid_1.getTotalHeight(rows.slice(0, rowInd));
        var scrollState = this.getScrollState();
        var gridRight = this.config.width + scrollState.x;
        var gridBottom = this.config.height + scrollState.y - this.config.headerRowHeight * this.config.$headerLevel;
        var cellTop = y - scrollState.y - rows[rowInd].$height;
    ...
    TreeGrid.prototype.expand = function (rowId) {
        if (this.data.haveItems(rowId)) {
            ...
            this.data.update(rowId, { $opened: true });
    ...
    TreeGrid.prototype.collapse = function (rowId) {
        if (this.data.haveItems(rowId)) {
            ...
            this.data.update(rowId, { $opened: false });
    ...
    TreeGrid.prototype.groupBy = function (property) {
        ...
        this._pregroupData = this._serialize();
        var grouppedData = this._groupBy(this._serialize(), property);
    ...
    TreeGrid.prototype.hideRow = function (rowId) {
        ...
        this.data.eachChild(rowId, function (i) { return _this.data.update(i.id, { hidden: true }); });
        this.data.filter(function (i) { return !i.hidden; });
        this.events.fire(ts_grid_1.GridEvents.afterRowShow, [row]);
    };
    TreeGrid.prototype.getCellRect = function (rowId, colId) {
        ...
        var colInd = core_1.findIndex(columns, function (obj) { return obj.id == colId; });
        var rowInd = core_1.findIndex(rows, function (obj) { return obj.id == rowId; });
        var x = ts_grid_1.getTotalWidth(columns.slice(0, colInd));
        var y = ts_grid_1.getTotalHeight(rows.slice(0, rowInd));
        return {
            x: x,
            y: y,
    ...
    TreeGrid.prototype._adjustColumnsWidth = function (rows, cols, adjust) {
        var _a, _b;
        if (adjust === void 0) { adjust = this.config.adjust; }
        var _c;
        var columnsWidth = {};
        if (adjust === "header" || adjust === true) {
            var currentCols = cols.filter(function (col) { return col.header; });
            var data = ts_grid_1.getMaxColsWidth(this._prepareColumnData(currentCols, "header"), currentCols, {
                font: "bold 14.4px Arial",
            }, "header");
            if (data) {
                for (var _i = 0, _d = Object.entries(data); _i < _d.length; _i++) {
                    var _e = _d[_i], key = _e[0], value = _e[1];
                    columnsWidth = Object.assign(columnsWidth, (_a = {},
                        _a[key] = +value + (ts_grid_1.isSortable(this.config, this.getColumn(key)) ? 36 : 16),
                        _a));
                }
            }
        }
        if (adjust === "data" || adjust === true) {
            var data = ts_grid_1.getMaxColsWidth(rows, cols, {
                font: "normal 14.4px Arial",
            }, "data");
            if (data) {
                for (var _f = 0, _g = Object.entries(data); _f < _g.length; _f++) {
                    var _h = _g[_f], key = _h[0], value = _h[1];
                    var offset = ((_c = cols[0]) === null || _c === void 0 ? void 0 : _c.id) === key ? this.data.getMaxLevel() * 24 + 16 : 16;
    ...
    TreeGrid.prototype._getRowIndex = function (rowId) {
        return core_1.findIndex(this._serialize(), function (obj) { return obj.id == rowId; });
    };
    TreeGrid.prototype._setEventHandlers = function () {
        ...
        this.events.on(ts_grid_1.GridEvents.filterChange, function (val, colId, filter) {
            ...
            _this.data.filter();
            _this.data.filter(_this._activeFilters, { add: true });
        });
    };
    TreeGrid.prototype._groupBy = function (data, columnId) {
        var groups = {};
        data.reduce(function (acc, item) {
            var groupName = typeof columnId !== "function" ? item[columnId] && item[columnId].toString() : columnId(item);
            if (!acc[groupName]) {
                acc[groupName] = [];
            }
